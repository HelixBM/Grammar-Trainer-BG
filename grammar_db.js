const EXERCISE_DB = {
  ...
  perfect_tenses: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "Did you ever see a ghost?", errorIndex: [0, 3], correction: ["Have", "seen"], hint: "When asking about life experiences without a specific time frame, use Present Perfect." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "When have you arrived in London?", errorIndex: [1, 3], correction: ["did", "arrive"], hint: "Questions starting with 'When' ask for a specific point in time, requiring Past Simple." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "How long have you been knowing your best friend?", errorIndex: [4, 5], correction: ["have", "known"], hint: "'Know' is a stative verb. It cannot take the continuous form, even for duration." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "That's the third time you forgot your homework this week.", errorIndex: [5], correction: ["have forgotten"], hint: "Phrases like 'the third time' trigger Present Perfect." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "Did you already finish the exam? That was fast!", errorIndex: [0, 3], correction: ["Have", "finished"], hint: "'Already' asking about a recently completed action takes Present Perfect." },
  ...
  future_tenses: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "Are you free tonight? No, I will study with Sarah.", errorIndex: [6, 7], correction: ["am", "studying"], hint: "An arrangement with someone else requires Present Continuous." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "Don't knock on his door at midnight. He will sleep.", errorIndex: [8, 9], correction: ["will", "be sleeping"], hint: "Action in progress at midnight." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "By the time we arrive, the movie will start.", errorIndex: [7, 8], correction: ["will", "have started"], hint: "The starting will happen before the arrival." },
  ...
  conditionals: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "Unless he doesn't apologize, I will never speak to him.", errorIndex: [2, 3], correction: ["apologizes"], hint: "Double negative: 'unless' already contains 'not'." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "If he would stop smoking, he would feel much healthier.", errorIndex: [2, 3], correction: ["stopped"], hint: "No 'would' in the 'if' clause." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "If I wasn't so afraid of heights, I would have gone skydiving with you last week.", errorIndex: [2], correction: ["weren't"], hint: "General truth/state (If I weren't) -> Past hypothetical action." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "If you had listened to me, you wouldn't have been in this mess right now.", errorIndex: [8, 9], correction: ["wouldn't", "be"], hint: "The mess is 'right now', so it must be 'wouldn't be'." },
  ...
  passive_voice: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "How much money was spending on the new stadium?", errorIndex: [4], correction: ["spent"], hint: "Passive requires V3 (spent), not V-ing (spending)." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "The bridge has being repaired for three months.", errorIndex: [3], correction: ["been"], hint: "Present Perfect Passive uses 'has been + V3'. 'Being' is for continuous tenses." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "Have the documents sent to the lawyers yet?", errorIndex: [3], correction: ["been sent"], hint: "The documents receive the action, they don't perform it." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "The package had being delivered to the wrong address.", errorIndex: [3], correction: ["been"], hint: "Past Perfect is 'had been', not 'had being'." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "The problem could have solve if we had acted sooner.", errorIndex: [4], correction: ["been solved"], hint: "Past modal passive requires 'been' + V3." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "You might be ask to show your ID at the entrance.", errorIndex: [3], correction: ["asked"], hint: "V3 is required." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "We are having a new kitchen install next week.", errorIndex: [6], correction: ["installed"], hint: "Requires the V3 (past participle)." },
  ...
  gerunds_infinitives: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "My doctor told me to give up to smoke immediately.", errorIndex: [7, 8], correction: ["smoking"], hint: "Phrasal verbs ending in prepositions (give up, keep on) take the gerund." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "We should postpone to make a decision until tomorrow.", errorIndex: [3, 4], correction: ["making"], hint: "'Postpone' (delay, put off) takes the gerund." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "She spends all her free time to read novels.", errorIndex: [6, 7], correction: ["reading"], hint: "'Spend time/money' is followed by the gerund." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "The doctor advised me resting for a few days.", errorIndex: [4], correction: ["to rest"], hint: "Advise someone TO DO something." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "I rushed to the station only for finding that the train had left.", errorIndex: [6, 7], correction: ["to", "find"], hint: "'Only to find' is a fixed infinitive phrase showing a disappointing result." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "I will never forget to meet the President; it was amazing.", errorIndex: [4, 5], correction: ["meeting"], hint: "Forget + ing = losing a memory of a past event. Forget + to = forgetting a task." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "I have a headache. Have you tried to take an aspirin?", errorIndex: [7, 8], correction: ["taking"], hint: "Taking an aspirin isn't physically difficult; it's an experiment to see if it cures the headache. Try + ing." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "If we want to catch the train, it means to leave right now.", errorIndex: [9, 10], correction: ["leaving"], hint: "It involves leaving -> Mean + ing." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "I regret to spend all my money on that stupid game last week.", errorIndex: [2, 3], correction: ["regret", "spending"], hint: "Regretting a past action requires the gerund." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "My parents didn't let me to go to the party.", errorIndex: [5], correction: ["-"], hint: "Let someone DO something (Bare Infinitive)." },
  ...
  modal_verbs: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "You mustn't to park here; it is a restricted zone.", errorIndex: [2], correction: ["-"], hint: "Modals are followed by the bare infinitive (no 'to')." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "You had better to study for the test.", errorIndex: [3], correction: ["-"], hint: "'Had better' is followed by the bare infinitive." },
      ...
      { type: "mc", instruction: "Choose the correct form.", sentence: "Don't call him now. He ________ be sleeping.", options: ["must", "might", "can't", "should"], correct: 1, hint: "Action possibly in progress right now (Modal + be + V-ing)." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "You must to be joking!", errorIndex: [2], correction: ["-"], hint: "Modals take the bare infinitive." },
      ...
      { type: "error", instruction: "Find the error.", sentence: "I ought to have listen to my parents' advice.", errorIndex: [4], correction: ["listened"], hint: "Ought to have + V3." },
  ...
  relative_participle_clauses: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "My grandfather, who he is 90 years old, still runs marathons.", errorIndex: [3], correction: ["-"], hint: "The relative pronoun 'who' is the subject. Do not repeat the subject pronoun 'he'." },
  ...
  linking_words: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "Unless you don't study, you will fail the Abitur.", errorIndex: [2], correction: ["-"], hint: "'Unless' already means 'if not'. Do not use a double negative." },
  ...
  quantifiers_pronouns: {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find the error.", sentence: "He carried three heavy baggages to the train.", errorIndex: [4], correction: ["bags", "pieces of baggage"], hint: "'Baggage/Luggage' is uncountable." },
