...
const EXERCISE_DB = {
  ...
  "question-formation": {
    ...
    exercises: [
      ...
      { type: "error", instruction: "Find and correct TWO errors.", sentence: "Can you tell me where does she work?", errorIndex: [5, 7], correction: ["-", "works?"], hint: "Indirect questions use normal word order — no inversion. Remove 'does' and add -s to the verb: 'where she works'." },
      ...
      { type: "error", instruction: "Find and correct TWO errors.", sentence: "I would like to know what time does the train leave.", errorIndex: [7, 10], correction: ["-", "leaves."], hint: "Indirect questions after 'I would like to know' use normal word order. Remove 'does' and add -s to the verb: 'what time the train leaves'." },
      ...
      { type: "error", instruction: "Find and correct TWO errors.", sentence: "She asked me what did I think about the proposal.", errorIndex: [4, 6], correction: ["-", "thought"], hint: "Reported/indirect questions use normal word order — remove 'did' and put the verb in past tense: 'what I thought'." },
